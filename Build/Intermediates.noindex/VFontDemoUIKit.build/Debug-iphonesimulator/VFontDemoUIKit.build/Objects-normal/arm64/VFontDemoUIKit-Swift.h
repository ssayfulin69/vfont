...
#ifndef VFONTDEMOUIKIT_SWIFT_H
#define VFONTDEMOUIKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VFontDemoUIKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14VFontDemoUIKit11AppDelegate")
...
SWIFT_CLASS("_TtC14VFontDemoUIKit7AxisRow")
@interface AxisRow : UITableViewCell
- (void)awakeFromNib;
- (IBAction)sliderValueDidChange:(id _Nonnull)sender;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC14VFontDemoUIKit12PaddingLabel")
...
SWIFT_CLASS("_TtC14VFontDemoUIKit12AxisTagLabel")
@interface AxisTagLabel : PaddingLabel
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC14VFontDemoUIKit22FontListViewController")
...
@interface FontListViewController (SWIFT_EXTENSION(VFontDemoUIKit)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC14VFontDemoUIKit7FontRow")
@interface FontRow : UITableViewCell
...
SWIFT_CLASS("_TtC14VFontDemoUIKit13SceneDelegate")
...
SWIFT_CLASS("_TtC14VFontDemoUIKit19VFontViewController")
@interface VFontViewController : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface VFontViewController (SWIFT_EXTENSION(VFontDemoUIKit)) <UITableViewDataSource>
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
@end
